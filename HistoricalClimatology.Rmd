...
tm_shape(LargeClusTorns) +
  tm_symbols(size = 4, col = "cDate", alpha = 0.8, palette = "YlOrRd", title.col = "Convective Day", border.alpha = 0) +
...
tm_shape(LargenT, is.master = TRUE, projection = "+proj=merc +lon_0=0 +k=1 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs") +
  tm_bubbles(col = "nT", border.col = "black", alpha = 0.8, palette = cr) +
tm_layout(legend.show = TRUE,
          legend.position = c("right", "bottom"),
          legend.text.size = 0.8,
          legend.title.size = 1.2,
          attr.position = c("left", "bottom"), 
          inner.margins = c(.25, .25, .25, .25))
...
#tm_shape(WeakTorns) +
#  tm_bubbles(size = 0.1, col = "blue", border.col = "blue", alpha = 0.5) +
tm_shape(LargeCas, is.master = TRUE, projection = "+proj=merc +lon_0=0 +k=1 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs") +
  tm_bubbles(col = "GroupDayCas", border.col = "black", alpha = 0.8, palette = cr, labels = c("500 to 1,000","1,001 to 2,000","2,001 to 3,000","3,001 to 4,000","4,001 to 5,000","5,001 to 6,000")) +
tm_layout(legend.show =TRUE,
          legend.position = c("right", "bottom"),
          legend.text.size = 0.8,
          legend.title.size = 1.2,
...
ggplot(stateBorders) +
  ...
  theme(plot.title = element_text(family = "Arial" , hjust = 0.5), legend.direction="horizontal", legend.position="bottom", legend.key.width = unit(1.5, 'cm'), legend.title = element_text("Tornado Density")) #+
...
p <- p + theme(axis.text.x = element_text(angle = 45), strip.text = element_text(size=16), axis.text=element_text(size=12), axis.title=element_text(size=14,face="bold"))
p
```
